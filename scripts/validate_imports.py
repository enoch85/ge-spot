            ...
            for node in ast.walk(tree):
                if isinstance(node, ast.Import):
                    ...
                    if level > 0:
                        ...
                        base_parts = current_package_parts[:-levels_to_go_up] if levels_to_go_up > 0 and levels_to_go_up <= len(current_package_parts) else current_package_parts
            ...
            try:
                with open(py_file, 'r', encoding='utf-8') as f:
                    for line_num, line in enumerate(f, 1):
                        ...
                        if 'Any' in stripped and ('typing.Any' in line or 'from typing import' in line or ': Any' in stripped or '[Any' in stripped or ', Any' in stripped):
...
def main():
    ...
    parser.add_argument(
        "--check-any",
        action="store_true",
        help="Check for usage of 'Any' type hint"
    )
    parser.add_argument(
        "--path",
        default=".",

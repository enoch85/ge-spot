...
class DateRangeUtilityTests(unittest.TestCase):
    ...
    def test_quarter_hourly_interval(self):
        ...
        date_ranges = generate_date_ranges(
            self.reference_time, interval=TimeInterval.QUARTER_HOURLY
        )
    ...
    def test_custom_parameters(self):
        ...
        self.assertGreaterEqual(
            fourth_range_start.date(),
            (self.reference_time - timedelta(days=3)).date(),
    ...
    def test_no_future(self):
        ...
        date_ranges = generate_date_ranges(self.reference_time, include_future=False)

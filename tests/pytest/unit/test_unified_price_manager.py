...
# Mock data for processed result (dict format - what sensors receive)
# This is generated by calling to_processed_result() on IntervalPriceData
# We use a simple dict for test assertions since some properties require tz_service
